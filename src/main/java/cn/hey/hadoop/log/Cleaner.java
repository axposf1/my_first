...
public class Cleaner extends Configuration implements Tool{
	...
	static class MyReducer extends Reducer<LongWritable, Text, Text, NullWritable>{
		protected void reduce(LongWritable k2, java.lang.Iterable<Text> v2s, Context context) throws java.io.IOException ,InterruptedException {
			for (Text v2 : v2s) {
...
//	}
	...
	private String parseTime(String line) throws Exception  {
		final int first = line.indexOf("[");
